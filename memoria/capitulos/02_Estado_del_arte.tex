...
El marco de equidad sin atributos demográficos explícitos propuesto por Lahoti et al.~\cite{lahoti2020fairness} motiva conceptualmente este enfoque; en el ámbito sanitario, se ha documentado el uso de \emph{importance weighting} para corregir el \emph{covariate shift} entre la distribución de entrenamiento y la distribución poblacional objetivo~\cite{algorithmfairnessmedicine2021}.
...
Remuestreo proporcional a referencia & Pre-procesado & Depende & S\'i & S\'i & Media & Media \\
...
booktitle = {Sex and Gender Effects in Pharmacology, Handbook of Experimental Pharmacology},
publisher = {Springer},
year    = {2023},
