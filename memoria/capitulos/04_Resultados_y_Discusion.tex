...
Por estricto rigor metodológico, es crucial subrayar que la representación de los diagramas de diferencia crítica (CD) para \textbf{T1DiabetesGranada} (Figura \ref{fig:cd_rmse_entire}a) y \textbf{REPLACE-BG} (Figura \ref{fig:cd_rmse_entire}b) tiene un carácter puramente ilustrativo del orden de rangos medios, careciendo de validez inferencial debido a la no significación de la prueba previa de Friedman ($p=0.120$ y $p=0.140$, respectivamente). En consecuencia, la barra de diferencia crítica (CD = 13.25) abarca de forma efectiva la totalidad de las condiciones evaluadas. Este solapamiento absoluto prohíbe categóricamente al lector extraer conclusiones sobre la superioridad de cualquier técnica sobre el baseline original. La equivalencia estadística observada entre las 21 condiciones experimentales confirma que, en estos dos repositorios, las fluctuaciones de error observadas son atribuibles a la varianza estocástica del proceso de entrenamiento y validación cruzada, y no a un efecto sistemático del reequilibrio demo
...
Por estricto rigor metodológico, es crucial subrayar que la representación de los diagramas de diferencia crítica (CD) para \textbf{T1DiabetesGranada} (Figura \ref{fig:cd_rmse_tbr2}a) y \textbf{REPLACE-BG} (Figura \ref{fig:cd_rmse_tbr2}b) tiene un carácter puramente ilustrativo del orden de rangos medios, careciendo de validez inferencial debido a la no significación de la prueba previa de Friedman ($p=0.120$ y $p=0.140$, respectivamente). En consecuencia, la barra de diferencia crítica (CD = 13.25) abarca de forma efectiva la totalidad de las condiciones evaluadas. Este solapamiento absoluto prohíbe categóricamente al lector extraer conclusiones sobre la superioridad de cualquier técnica sobre el baseline original. La equivalencia estadística observada entre las 21 condiciones experimentales confirma que, en estos dos repositorios, las fluctuaciones de error observadas son atribuibles a la varianza estocástica del proceso de entrenamiento y validación cruzada, y no a un efecto sistemático del reequilibrio demo
...
Este fenómeno puede caracterizarse como \textbf{homeostasis demográfica estructural}:
el diseño del estudio actúa como regulador implícito del balance, de modo que el
balanceo explícito no añade información que la distribución de los datos no contenga
ya. El hallazgo tiene una lectura normativa clara: una adecuada planificación en la
...
\begin{enumerate}
    ...
    \item \textbf{Régimen de homeostasis por diseño} (REPLACE-BG): el protocolo
    del estudio garantiza una distribución de ventanas aproximadamente equilibrada.
    El balanceo no encuentra desequilibrio estructural que corregir.
