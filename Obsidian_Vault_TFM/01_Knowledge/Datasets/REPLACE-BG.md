...
[[REPLACE-BG]] es uno de los tres datasets utilizados en este TFM.
...
### Datos de Glucemia
- **Archivo:** `Glucose_measurements_REPLACE-BG_FILTERED_*.parquet`
...
- **Demografía:** `[[Patient_info.parquet]]`

### Archivos Generados
- **Ventanas:** `windows_with_5folds_REPLACE-BG_*.parquet`
