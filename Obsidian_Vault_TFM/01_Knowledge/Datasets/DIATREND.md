...
[[DIATREND]] es uno de los tres datasets utilizados en este TFM.
...
### Datos de Glucemia
- **Archivo:** `Glucose_measurements_DIATREND_FILTERED_*.parquet`
...
### Archivos Generados
- **Ventanas:** `windows_with_5folds_DIATREND_*.parquet`
